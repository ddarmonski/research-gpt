...
exports.DatePickerBase = React.forwardRef(function (propsWithoutDefaults, forwardedRef) {
    ...
    var renderReadOnlyInput = function (inputProps) {
        ...
        return (React.createElement("div", tslib_1.__assign({}, divProps, { className: (0, utilities_1.css)(divProps.className, classNames.readOnlyTextField), tabIndex: tabIndex || 0 }), formattedDate || (
